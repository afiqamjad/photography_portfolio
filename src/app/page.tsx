    ...
    <div className="flex flex-col w-dvw h-dvh">
      ...
      <div className="grow flex flex-row justify-evenly">
        ...
        <div className="flex flex-col items-evenly h-[100%] w-[23%]">
          ...
          <Lightbox className="mt-[5.5%]" src="https://res.cloudinary.com/dfcqlwnxu/image/upload/v1745542323/afiqPort-14_s6ljqy.jpg" width={350} height={350} alt=""/>
          <Lightbox className="mt-[5.5%]" src="https://res.cloudinary.com/dfcqlwnxu/image/upload/v1745541690/afiqPort-4_bhlrar.jpg" width={350} height={350} alt=""/>
        ...
        <div className="flex flex-col items-evenly h-[100%] w-[23%]">
          ...
          <Lightbox className="mt-[5.5%]" src="https://res.cloudinary.com/dfcqlwnxu/image/upload/v1745517471/portfolioAfiq-7_erocfg.jpg" width={350} height={350} alt=""/>
          ...
          <Lightbox className="mt-[5.5%]" src="https://res.cloudinary.com/dfcqlwnxu/image/upload/v1745541558/afiqPort-2_kqsnpc.jpg" width={350} height={350} alt=""/>
          <Lightbox className="mt-[5.5%]" src="https://res.cloudinary.com/dfcqlwnxu/image/upload/v1745541980/afiqPort-6_or4jhr.jpg" width={350} height={350} alt=""/>
        </div>
        <div className="flex flex-col items-evenly h-[100%] w-[23%]">
          <Lightbox src="https://res.cloudinary.com/dfcqlwnxu/image/upload/v1745541631/bin_khairir_mot-3_lkcbl7.jpg" width={350} height={350} alt=""/>
      ...
      <Footer/>
      <Script
          src="/js/lightgallery.umd.js"
          strategy="beforeInteractive"
        />
        <Script
          src="/js/plugins/lg-thumbnail.umd.js"
          strategy="afterInteractive"
        />
        <Script
          src="/js/plugins/lg-zoom.umd.js"
          strategy="afterInteractive"
        />
    </div>
  );
