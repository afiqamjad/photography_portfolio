  ...
  return (
    <>
      ...
      <dialog ref={dialogRef} onClick={closeLightbox} className="m-auto max-w-screen max-h-screen border-0 p-0 bg-transparent w-[90vw] h-[99vh] backdrop:bg-black/85 focus:outline-none outline-none" >
            <button className='md:hidden z-50 text-md text-white h-[1.5rem] w-[1.5rem] border-1 rounded-lg border-white text-center absolute top-5 left-[50%] active:bg-gray-50/60 focus:outline-none'>X</button>
